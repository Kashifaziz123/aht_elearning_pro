...
//    var VideoPlayer = require('website_slides.fullscreen').VideoPlayer;
    ...
    publicWidget.registry.websiteSlidesFullscreenPlayer.include({
        ...
        xmlDependencies: ['/e_learning_custom/static/src/xml/website_slides_fullscreen.xml', '/e_learning_custom/static/src/xml/website_image.xml', '/website_slides/static/src/xml/website_slides_share.xml'],
    });
